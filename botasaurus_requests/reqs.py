...
class TLSRequest:
    ...
    Args:
        ...
        session (session.TLSSession, optional): Associated `TLSSession`. Defaults to None.
    ...
    Attributes:
        ...
        url (str): URL to request.
        session (session.TLSSession): Associated `TLSSession`.
        kwargs (dict): The rest arguments for ``Session.request``.
        response (response.Response): Resulting ``Response``.
